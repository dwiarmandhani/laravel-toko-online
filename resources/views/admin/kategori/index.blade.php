...
<div class="card">
    <div class="card-header bg-white">
        ...
        <td class="text-center">
            ...
            <button class="btn btn-sm btn-danger d-inline" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $ktg->id_kat }}').submit();">
                Delete
            </button>
            <form id="delete-form-{{ $ktg->id_kat }}" action="{{ route('kategori.destroy', ['kategori'=>$ktg->id_kat]) }}" method="POST" style="display: none;">
                @csrf
                @method('DELETE')
            </form>
        </td>
